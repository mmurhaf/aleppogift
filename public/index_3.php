    ...
    <main class="container my-4">
        ...
        <section class="hero-section modern-hero text-center mb-5">
            <div class="hero-content">
                ...
                <h1 class="hero-title">ِAleppo Gift - Premium Gifts From China</h1>
        ...
        <div class="products-section">
            ...
            <div class="product-grid">
                <?php foreach ($products as $p): ?>
                    ...
                    <!-- Product Actions - Simplified and Enhanced -->
                    <div class="product-actions mt-auto">
                        <!-- Add to Cart Button -->
                        <form class="add-to-cart-form mb-2" method="post" action="ajax/add_to_cart.php">
                        ...
                        <div class="d-flex justify-content-between gap-2">
                            <a href="https://aleppogift.com/product.php?id=<?= $p['id']; ?>" 
                               class="btn btn-outline-secondary flex-grow-1" title="View Details">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a class="btn btn-outline-success whatsapp-share-btn" 
                            ...
                            <button class="btn btn-outline-info enhanced-share-btn" 
                                    title="Share Product"
                                    data-name="<?= htmlspecialchars($p['name_en']) ?>"
                                    data-price="<?= number_format($p['price'], 2) ?>"
                                    data-id="<?= $p['id'] ?>"
                                    data-url="<?= 'https://aleppogift.com/product.php?id=' . $p['id'] ?>">
