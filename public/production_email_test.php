...
<head>
    ...
    <title>Email Test - AleppoGift Production</title>
    <style>
...
<body>
    <div class="container">
        <h1>📧 AleppoGift Email Test - Production</h1>
            ...
            if (!$test_email) {
                ...
                try {
                    ...
                    if ($result) {
                        ...
                        echo '<li>Check if the password is correct: Salem1972#a</li>';
                        echo '<li>Try the alternative password: Salem1972#i</li>';
        ...
        <div style="margin-top: 30px;">
            <h3>🔗 Other Email Tests</h3>
            <p><a href="smtp_test.php">🔧 SMTP Diagnostic Test</a> - Advanced SMTP connection testing</p>
            <p><a href="checkout_email_test.php">🛒 Checkout Email Test</a> - Test order email functions</p>
            <p><a href="checkout_diagnostic.php">🔍 Checkout Diagnostic</a> - Overall checkout system test</p>
        </div>
        
        <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #eee; color: #666; text-align: center;">
            <small>AleppoGift Email Test • Production Server Version</small>
        </div>
    </div>
</body>
</html>
