                            ...
                            <tr>
                                <td style="min-width: 250px;">
                                    <div style="display: flex; align-items: center; gap: 15px;">
                                        ...
                                        <?php endif; ?>
                                        <div>
                                            <div style="font-weight: 500;"><?= htmlspecialchars($item['product_name'] ?? 'Unknown Product') ?></div>
                                            <div style="font-size: 0.8rem; color: #6c757d;">SKU: <?= htmlspecialchars($item['sku'] ?? '—') ?></div>
                                        </div>
                                    </div>
                                </td>
                                <td>
