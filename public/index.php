...
<body>
    ...
    <!-- Main Content -->
    <main class="container-fluid my-4" style="max-width: 1600px;"">
        <!-- Hero Section -->
        <section class="hero-section modern-hero text-center mb-5">
            <div class="hero-content">
                <div class="hero-badge">✨ New Collection / مجموعة جديدة</div>
                <h1 class="hero-title" style="color : white;">Aleppo Gift - Premium Gifts / هدايا حلب - هدايا فاخرة</h1>
                <p class="hero-subtitle">
                    Discover our unique collection of luxury and branded gifts that bring joy and elegance to every occasion
                / اكتشف مجموعتنا الفريدة من الهدايا الفاخرة والماركات التي تضفي البهجة والأناقة على كل مناسبة
                </p>
                <div class="hero-actions">
                    <a href="#products" class="btn btn-primary btn-hero">
                        <i class="fas fa-shopping-bag me-2"></i>Shop Now / تسوق الآن
                    </a>
                    <a href="#categories" class="btn btn-outline btn-hero">
                        <i class="fas fa-list me-2"></i>Browse Categories / تصفح الفئات
                    </a>
                </div>
            </div>
        ...
        <section id="products" class="mb-5">
            <div class="filter-header mb-4">
                <h2 class="filter-title">Find Your Perfect Gift / ابحث عن الهدية المثالية</h2>
                <p class="filter-subtitle">Use our advanced filters to discover exactly what you're looking for / استخدم مرشحاتنا المتقدمة لاكتشاف ما تبحث عنه بالضبط</p>
            </div>
                ...
                <div class="filter-grid">
                    <div class="filter-group">
                        <label for="category" class="filter-label">
                            <i class="fas fa-tags me-2"></i>Category / الفئة
                        </label>
                    ...
                    <div class="filter-actions">
                        <button type="submit" class="btn btn-primary filter-submit">
                            <i class="fas fa-filter me-2"></i>Search / بحث 
                        </button>
                        <a href="?" class="btn btn-outline reset-filters" title="Clear all filters">
                            <i class="fas fa-undo me-2"></i>Reset / إعادة 
                        </a>
                    </div>
                </div>
            </form>
...
<!-- Pagination Section -->
                ...
                <?php foreach ($products as $p): ?>
                    <div class="modern-product-card">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <!-- Product Actions - Unified Button Layout -->
                            <div class="product-actions mt-auto">
                                ...
                                <div class="action-grid">
                                    ...
                                    <div class="d-flex gap-2">
                                        ...
                                        <!-- WhatsApp -->
                                        <a class="btn btn-outline-success btn-sm flex-fill whatsapp-btn" 
                                        ...
                                        <!-- Share -->
                                        <button class="btn btn-outline-info btn-sm flex-fill share-btn" 
                                                title="Share Product"
                                        ...
                                        <!-- Wishlist -->
                                        <button class="btn btn-outline-danger btn-sm flex-fill btn-wishlist" 
                                                data-id="<?= $p['id']; ?>" 
                                                title="Add to Wishlist">
                                            <i class="far fa-heart"></i>
        ...
        <section class="mb-4">
            <div class="pagination-container">
                <div class="pagination-info">Page <?= $currentPage ?> of <?= $totalPages ?> (<?= $totalProducts ?> products total)</div>
